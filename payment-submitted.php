...
session_start();
       /* if(!isset($_SESSION['User_Name'])){
            $_GLOBALS['message']="Session Timeout. Click here to <a href=\"my-account.php\">Re-LogIn</a>";
...
<head>
	...
	<title>Payment-Submitted | OneTech</title>
	<meta name="description" content="Payment Submitted Confirm Payment OneTech Home of Ethiopian Best Ethiopian Online Store Order and Buy Products Online ecommerce OneTech">
        		...
        		<div class="wn_checkout_wrap">
        				...
        				<div class="customer_details">
							...
							<div class="account__form" style="background-color:#A93636; color:#FFFFFF;">
						                ...
						                <center><span><h6>Payment Already Submitted !</h6></span></center>
							...
							<div class="" >       
								...
								<p>Hello, We have Received the payment details you submitted with <b>Invoice #:   <?php echo $inv_num; ?></p></b>
								<p>If the payment details are correct your order will be Approved with in Hours, and you are ready to get your Order</p>
